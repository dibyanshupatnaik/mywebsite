...
var AddMarker = function(place) {
  var myLatLng = { lat: place.location.lat, lng: place.location.lng };
  ...
  if (self.marker) {
    self.markersArray().push([myLatLng, self.marker]);
...
var FoursquareData = function(place) {
  ...
  var client_id = "ZG0FZ2ZJ00NVTZEK2YLORO50HYJGO1XTFCBN2KTVYWN2Z2SV";
  var client_secret = "YNNEH4MXM50R04LNNDMESQIMRZL5XOVN1ITGA3K4CU2E2KLR";
  var FoursquareUrl =
...
var viewModel = function() {
  ...
  this.viewPlace = function(place) {
    var check_myLatLng = { lat: place.location.lat, lng: place.location.lng };
    stopAnimation();
